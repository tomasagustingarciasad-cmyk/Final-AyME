...
grid on; grid minor;
title('Respuesta de posición frente a consigna de velocidad con controlador  en código', 'FontSize', 18, 'FontWeight', 'bold');
...
grid on; grid minor;
title('Respuesta de velocidad con controlador  en código', 'FontSize', 18, 'FontWeight', 'bold');
...
grid on; grid minor;
title('Corrientes de fase con controlador  en código', 'FontSize', 18, 'FontWeight', 'bold');
...
grid on; grid minor;
title('Tensiones de fase frente a controlador  en código', 'FontSize', 18, 'FontWeight', 'bold');
...
grid on; grid minor;
title('Temperatura de estator real vs sensada con controlador en código', 'FontSize', 18, 'FontWeight', 'bold');
